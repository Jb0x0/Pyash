...
*  **Secure Sandbox Environment:** Pyash operates fully in a sandboxed "shell" folder, Pyash specifically everages `os.path.commonpath` to ensure users absolutely cannot read, write, or navigate to files outside the designated shell root folder.
